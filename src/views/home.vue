  ...
  <main id="c-top">
                ...
                <div class="l-container">
                    <div class="l-mv--item">
                        ...
                        <figure class="text-center">
                            <img src="../assets/img1.svg" alt="くふうで生活を賢く・楽しく">
                        </figure>
                    </div>
                </div>
            </section>
                ...
                <div class="l-container">
                    <div class="l-top1--item">
                        <div class="c-box c-box1">
                            <figure><img src="../assets/img-top1-small1.svg" class="hidden_pc" alt="結婚に"></figure>
                            <dl>
                        ...
                        <div class="c-box c-box2">
                            <figure><img src="../assets/img-top1-small2.svg" class="hidden_pc" alt="住まいに"></figure>
                            <dl>
                        ...
                        <div class="c-box c-box3">
                            <figure><img src="../assets/img-top1-small3.svg" class="hidden_pc" alt="お金に"></figure>
                            <dl>
            ...
            <section class="l-top2">
                <div class="l-container">
                    ...
                    <figure class="text-center">
                        <img src="../assets/img1-top2.svg" alt="には、わかったとできたの両方が必要です">
                    </figure>
                    <figure class="text-center hidden_sp">
                        <img src="../assets/img4-top2.svg" alt="には、わかったとできたの両方が必要です">
                    </figure>
                    <figure class="text-center hidden_pc">
                        <img src="../assets/img2-top2.svg" alt="には、わかったとできたの両方が必要です">
                    </figure>
                    <figure class="text-center hidden_pc">
                        <img src="../assets/img3-top2.svg" alt="には、わかったとできたの両方が必要です">
                    </figure>
                </div>
            </section>
            <section class="l-top3 text-center">
                <div class="l-container">
                    ...
                    <figure>
                        <img class="hidden_sp" width="807" src="../assets/img-top3-pc.svg" alt="くふうグループが持つ機能で、の実現を応援します。">
                        <img class="hidden_pc" src="../assets/img-top3-sp.svg" alt="くふうグループが持つ機能で、の実現を応援します。">
                    </figure>
